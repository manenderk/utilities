...
};`})})]})})]})})]})}),e.jsxs("div",{className:"col-md-6 mb-3",children:[e.jsx("h5",{className:"text-center",children:"SQL Server Params"}),e.jsx("div",{className:"form-group",children:e.jsx("textarea",{rows:"20",className:"form-control",value:n,onChange:t=>y(t.target.value)})})]}),e.jsxs("div",{className:"col-md-6 mb-3",children:[e.jsx("h5",{className:"text-center",children:"C# Code"}),e.jsxs("div",{className:"form-group position-relative",children:[e.jsx("textarea",{rows:"20",className:"form-control",value:p,onChange:t=>S(t.target.value)}),e.jsx("div",{className:"input-copy-button",children:e.jsx(N,{label:"Copy",children:e.jsx("button",{className:"btn btn-secondary",onClick:()=>P(null,p),children:e.jsx("i",{className:"fa fa-clipboard"})})})})]})]})]})};export{j as default};
